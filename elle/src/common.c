...
#include <elle/inc/newlib/genstd.h>
#include <elle/inc/common.h>
#include <elle/inc/buf.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
#include "math.h"
#include <elle/inc/elua_adc.h>
#include <elle/inc/term.h>
#include <elle/inc/xmodem.h>
#include <elle/inc/elua_int.h>
#include <elle/inc/sermux.h>
#include <elle/src/lua/lua.h>
#include <elle/src/lua/lapi.h>
#include <elle/src/lua/lauxlib.h>
#include <elle/src/platform/xmc4700/ps2.h>
...
extern bool shell_cmd_buffering;
extern FILE * shellfp;
...
static void lcd_out( int fd, char c )
{
  fd = fd;
  if( shell_cmd_buffering )
    fputc( c, shellfp );
  else
    terminal_put_char( &lcd, ( uint8_t )c );
}

static int ps2_recv( timer_data_type to )
{
  char c;
...
void cmn_platform_init()
{
  ...
  std_set_send_func( lcd_out );
  std_set_get_func( ps2_recv );
#else
  // Set the send/recv functions
