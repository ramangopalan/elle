...
/*
  ...
  ** Modified by Raman Gopalan <ramangopalan@gmail.com>, Jan, 2020 for Elle.
...
static uint8_t char_buffer = 0;
static uint8_t utf8_next = 0;
static const ps2_keymap_t *keymap = NULL;
unsigned long millis_counter = 0U;
...
const ps2_keymap_t ps2_keymap_german = {
  // without shift
	{0, PS2_F9, 0, PS2_F5, PS2_F3, PS2_F1, PS2_F2, PS2_F12,
	0, PS2_F10, PS2_F8, PS2_F6, PS2_F4, PS2_TAB, '^', 0,
	0, 0 /*Lalt*/, 0 /*Lshift*/, 0, 0 /*Lctrl*/, 'q', '1', 0,
...
const ps2_keymap_t ps2_keymap_french = {
  // without shift
	{0, PS2_F9, 0, PS2_F5, PS2_F3, PS2_F1, PS2_F2, PS2_F12,
...
const ps2_keymap_t ps2_keymap_spanish = {
		// without shift
		{0, PS2_F9, 0, PS2_F5, PS2_F3, PS2_F1, PS2_F2, PS2_F12,
...
const ps2_keymap_t ps2_keymap_italian = {
		// without shift
		{0, PS2_F9, 0, PS2_F5, PS2_F3, PS2_F1, PS2_F2, PS2_F12,
		 0, PS2_F10, PS2_F8, PS2_F6, PS2_F4, PS2_TAB, '\\', 0,
		 0, 0 /*Lalt*/, 0 /*Lshift*/, 0, 0 /*Lctrl*/, 'q', '1', 0,
...
const ps2_keymap_t ps2_keymap_uk = {
...
// The ISR for the external interrupt: Crazy de-buggers!
void ps2_interrupt_handler (void) {
	...
	val = DIGITAL_IO_GetInput(&PS2_DATA_PIN);
	now_ms = millis();
	if (now_ms - prev_ms > MILLIS_COUNTER_LIMIT) {
		bitcount = 0;
		incoming = 0;
	}
	prev_ms = now_ms;
...
bool ps2_available (void) {
	if (char_buffer || utf8_next) return true;
	char_buffer = get_iso8859_code();
	if (char_buffer) return true;
	return false;
}
...
void ps2_begin (const ps2_keymap_t *map) {
  keymap = map;
  head = 0;
  tail = 0;
  // initialize the pins
  // Raman: Huh? What pins? Scratching head.. Pants! Not in this function! :)
}
